...
Route::group(['prefix' => '', 'middleware' => 'is.auth'], function(){
    Route::get('/dashboard', function () {return 'berhasil login';})->name('dashboard');
});

Route::group(['prefix' => 'mst', 'middleware' => 'is.auth'], function () {
...
Route::group(['prefix' => 'trn', 'middleware' => 'is.auth'], function () {
